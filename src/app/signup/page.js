...
import {
  ...
  ShieldCheck, Landmark, Users, BarChart3, Mail, Lock, Phone, Quote, UserPlus, Check
} from 'lucide-react';
...
function SignupContent() {
  ...
  const switchTab = (t) => {
    setTab(t);
    setError('');
    setForm({ collegeCode: '', setupKey: '', name: '', email: '', mobile: '', password: '', confirmPassword: '' });
  };
  ...
  const hasNumberOrSpec = /[0-9!@#$%^&*(),.?":{}|<>]/.test(pass);
  ...
  const handleSubmit = async (e) => {
    ...
    if (!hasMinLength || !hasLower || !hasUpper || !hasNumberOrSpec) {
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '84px 1fr', gap: 10 }}>
                  <div style={{
                    height: 46, borderRadius: 10, border: '1px solid #E2E8F0', background: '#F8FAFC',
                    display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6,
                    fontSize: 14, fontWeight: 600, color: '#334155',
                  }}>
                    <Phone size={14} color="#64748B" /> +91
                  </div>
                  <input
                    type="tel"
                    className="signup-input"
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 13, fontWeight: 700, color: '#1E40AF', marginBottom: 8 }}>
                  <Lock size={14} color="#2563EB" />
                  <span>Password must contain:</span>
                </div>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, fontSize: 12 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6, color: hasMinLength ? '#16A34A' : '#64748B', fontWeight: hasMinLength ? 600 : 400 }}>
                    <Check size={14} color={hasMinLength ? '#16A34A' : '#94A3B8'} /> At least 8 characters
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6, color: hasLower ? '#16A34A' : '#64748B', fontWeight: hasLower ? 600 : 400 }}>
                    <Check size={14} color={hasLower ? '#16A34A' : '#94A3B8'} /> One lowercase letter (a-z)
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6, color: hasUpper ? '#16A34A' : '#64748B', fontWeight: hasUpper ? 600 : 400 }}>
                    <Check size={14} color={hasUpper ? '#16A34A' : '#94A3B8'} /> One uppercase letter (A-Z)
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6, color: hasNumberOrSpec ? '#16A34A' : '#64748B', fontWeight: hasNumberOrSpec ? 600 : 400 }}>
                    <Check size={14} color={hasNumberOrSpec ? '#16A34A' : '#94A3B8'} /> One number or symbol
                  </div>
                </div>
              </div>
