    ...
    <div style={{ padding: '28px', fontFamily: 'Inter,sans-serif', background: '#F9FAFB', minHeight: '100%' }}>
      ...
      <div style={{ maxWidth: 820, margin: '0 auto' }}>
        ...
        <div style={{ background: 'white', borderRadius: 12, border: '1px solid #E5E7EB', padding: 28, marginBottom: 20, display: 'flex', alignItems: 'center', gap: 24 }}>
          <div style={{ width: 80, height: 80, borderRadius: '50%', background: 'linear-gradient(135deg,#6366F1,#A78BFA)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 28, fontWeight: 800, color: 'white', flexShrink: 0 }}>
            {user?.avatarUrl
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
              <span style={{ padding: '3px 12px', borderRadius: 20, background: '#EEF2FF', color: '#6366F1', fontSize: 12, fontWeight: 600, textTransform: 'capitalize' }}>{user?.role}</span>
        ...
        <SectionCard title="Personal Information" subtitle="Update your profile details">
          <form onSubmit={saveProfile}>
            ...
            <button type="submit" disabled={saving}
              style={{ marginTop: 20, display: 'flex', alignItems: 'center', gap: 8, padding: '10px 24px', border: 'none', borderRadius: 8, background: 'linear-gradient(135deg,#6366F1,#8B5CF6)', color: 'white', fontSize: 14, fontWeight: 700, cursor: 'pointer', fontFamily: 'Inter' }}>
